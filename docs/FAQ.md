...
To skip the dialog entirely, install from Terminal: `curl -fsSL https://raw.githubusercontent.com/Milanpatel35/calma/main/Scripts/install.sh | bash`. It verifies the published checksum, installs to `/Applications` and clears the quarantine flag.
